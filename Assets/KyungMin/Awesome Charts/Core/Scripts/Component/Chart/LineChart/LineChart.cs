...
namespace AwesomeCharts {
    ...
    public class LineChart : AxisBaseChart<LineData> {
        ...
        protected override void OnUpdateAxis () {
            ...
            horizontalAxisValueFormatter.config = AxisConfig.VerticalAxisConfig.ValueFormatterConfig;
            verticalAxisValueFormatter.config = AxisConfig.HorizontalAxisConfig.ValueFormatterConfig;
